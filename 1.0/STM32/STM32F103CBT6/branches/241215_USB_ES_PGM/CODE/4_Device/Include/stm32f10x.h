...
typedef struct
{
  ...
  __IO uint16_t CTLR;                 /*!< Control register,                          Address offset: 0x40 */
  __IO uint16_t RESERVED8;            /*!< Reserved */
  __IO uint16_t ISTAR;                 /*!< Interrupt status register,                 Address offset: 0x44 */
  __IO uint16_t RESERVED9;            /*!< Reserved */
  __IO uint16_t FRNR;                  /*!< Frame number register,                     Address offset: 0x48 */
...
/* USB device FS */
#define USB_BASE              (APB1PERIPH_BASE + 0x5C00) /*!< USB_IP Peripheral Registers base address */
...
#define BITBAND_PERI_BASE (PERIPH_BASE + BITBAND_OFFSET)
#define BITBAND_PERI(addr, bitnum) (BITBAND_PERI_BASE + (((uint32_t)(addr) - PERIPH_BASE) << 5) + ((uint32_t)(bitnum) << 2))
